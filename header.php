		...
		<div class="container header__container">
			...
			<div class="header__social">
				<a id="header_icon_wa" href="<?php the_field( 'op_ssylka_na_whatsapp', 'option' ); ?>">
					<img src="<?php the_badden_assets('img', 'whatsapp.svg'); ?>" alt="Связаться с нами в WhatsApp">
				</a>
				<a id="header_icon_vk" href="<?php the_field( 'op_ssylka_na_vk', 'option' ); ?>">
					<img src="<?php the_badden_assets('img', 'vk.svg'); ?>" alt="Мы в ВКонтакте">
				</a>
				<a id="header_icon_phone" href="tel:<?php the_field( 'op_telefon', 'option' ); ?>">
					<img src="<?php the_badden_assets('img', 'phone_white.svg'); ?>" alt="Позвонить">
				</a>
			</div>
